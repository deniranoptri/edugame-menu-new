...
const targetStr = `                {lang === 'en' ? 'Can the games be played on mobile phones?' : 'Apakah game dapat dimainkan di HP?'}
              </strong>
...
const replacement = `                {lang === 'en' ? 'Can the games be played on mobile phones?' : 'Apakah game dapat dimainkan di HP?'}
            ...
            <li>
              ...
              <span className="text-sm opacity-80 font-medium">
                {lang === 'en' 
                   ? 'Yes, our entire collection of interactive educational games is 100% free for teachers and students to access without any subscription fees.' 
                   : 'Ya, seluruh koleksi game edukasi interaktif kami 100% gratis untuk diakses oleh guru dan siswa tanpa perlu biaya berlangganan.'}
              </span>
            </li>
            <li>
              <strong className="block text-sm font-black text-[#E45C63]">
